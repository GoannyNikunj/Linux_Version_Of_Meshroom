...
set(Ceres_DIR /opt/AliceVision_install/lib64/cmake/Ceres)
...
if(ALICEVISION_HAVE_CCTAG)
  set(CCTag_DIR /opt/AliceVision_install/lib64/cmake/CCTag)
...
if(ALICEVISION_HAVE_APRILTAG)
  set(apriltag_DIR /opt/AliceVision_install/share/apriltag/cmake)
...
if(ALICEVISION_HAVE_OPENCV)
  set(OpenCV_DIR /opt/AliceVision_install/lib64/cmake/opencv4)
...
find_dependency(Boost COMPONENTS atomic;container;date_time;filesystem;graph;json;log;log_setup;program_options;regex;serialization;system;thread;timer)
set(BOOST_NO_CXX11 OFF)
if(BOOST_NO_CXX11)
 add_definitions(-DBOOST_NO_CXX11_SCOPED_ENUMS)
endif()

set(ALICEVISION_BUILD_SFM ON)
